...
message=Label(win,text="Enter a name 1:",fg="blue",font=("Britannic Bold",20))
...
message=Label(win,text="Enter a  name 2:",fg="blue",font=("Britannic Bold",20))
...
click=Button(win,text="concatenation", command=names,fg="blue",font=("Britannic Bold",20))
