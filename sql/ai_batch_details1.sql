...
create table ai_batch_personal_details
(
sno int not null primary key auto_increment,
Name varchar(50),
DOB date,
Aadhar_Number long not null,	
Biometric_ID long not null,
Primary_Contact_No long not null,
Secondary_Contact_No long not null,
WhatsApp_No long ,
...
Father_Name varchar(60),
 ...
 select * from ai_batch_personal_details;
 
 insert into ai_batch_personal_details values 
(1,'Abdul Rahman  B','2001-01-15',669092087983,92087983,9952630126,6369696359,9952630126,'TI2023M-C01E438
...
insert into ai_batch_personal_details values
(2,'Arun T','2002-07-07',341246643302,46643302,8525880306,6382506148,8525880306,'PU2023M-C01E488
','Password@123','BSC','Computer science','NIL','NIL',2023,'','arunaathi41@gmail.com','3/4 Thirupur ,Thirupur (po),Kulathur(tk),Senaiyakuti,Pudukkottai (Dt), 622502','','Tamil selvam','','Suppu laxmi');

insert into ai_batch_personal_details values
(3,'Aysha sithika L','1988-01-11',784654756225,54756225,8124823036,8610353074,8124823036,'TI2023F-C01E78D
','Password@123','12','Computer science','NIL','NIL',2005,'','aslamshabeen@gmail.com','LIGII,2801, BISMILLAH MANZIL,Anna nagar,phase 2 Navalpattu, Trichy -26','Trichy','','Nazrul Islam(Husband)','Amthul jabeen');

insert into ai_batch_personal_details values
(4,'Bhavani R','2002-10-13',935775705642,75705642,6380185097,9659871377,6380185097,'Pu2023F-C01E44D
...
insert into ai_batch_personal_details values
(5,'Fathima M','2002-12-17',622631324614,31324614,6374041818,9791676433,6374041818,'TI2023F-C01E43B
...
insert into ai_batch_personal_details values
(6,'Ghouse bi S','1989-08-14',818393990050,93990050,9994286043,7708475065,9994286043,'TI2023F-C01E46D
','Password@123','B.A.','English','NIL','NIL',2010,'','happydhillu@gmail.com','MIG 49, Phase 1, Anna nagar,TNUDP,trichy-620026.','Trichy','','Juber khan. B(Husband)','Zarina Begum');

insert into ai_batch_personal_details values
(7,'Gnanagowsalya K','2003-04-29',418718821662,18821662,7094373123,9965452410,7094373123,'TI2023F-C01E474
','Password@123','Bsc ','Computer science','NIL','NIL',2023,'kkowsalyaai01@gmail.com','kowsalyakannan29@gmail.com','26/1, College road,Sri Ram theatre near, Musiri,Trichy(Dt)','Trichy','Kannan.A','','Sundhari.K');

insert into ai_batch_personal_details values
(8,'Hajeera Sithika L','1992-06-11',430341868981,41868981,8056447098,9751471799,8056447098,'TI2023F-C01E796
','Password@123','BA','English','NIL','NIL',2013,'','hajeerasithka2021@gmail.com','3, murugesan street, M.K. kottai, trichy','Trichy','','Syed Azarudeen','Amthul jabeen');


insert into ai_batch_personal_details values
(9,'HARIHARAN A','2001-10-11',304765424440,65424440,9363649175,9363649175,9363649175,'PE2023M-C01E437
','Password@123','BE','EEE','NIL','NIL',2023,'','hariharananbu2001@gmail.com','2/225 North st keelapuliyur po Kunnam tk Perambalur dt 621115','Perambalur','ANBALAGAN D','','Anjalai A');


insert into ai_batch_personal_details values
(10,'Jayalakshmi R','1997-02-06',432445616668,45616668,9500628375,6385632493,6385632493,'TI2023F-C01E444
','Password@123','BCA','Computer application','MCA','Computer Application
...
insert into ai_batch_personal_details values
(11,'Jothika J','2003-01-08',693941180387,41180387,9585607631,9843412199,9585607631,'TI2023F-C01E555
...
insert into ai_batch_personal_details values
(12,'Kalaiarasan A','1987-07-29',447595386464,95386464,9600330846,9994057344,9600330846,'TI2023M-C01E78B
','Password@123','B.com','Commerce','NIL','NIL',2009,'Kalaiarasanayyavooai0@gmail.com','Kalai29.7@gmail.com','2/337 navalpattu burma colony oft po trichy 16','Trichy','K.Ayyavoo','','A.Vasanthi');

insert into ai_batch_personal_details values
(13,'Kayalvizhi M','1998-09-13',987876654,6767889,7339221973,9698821473,7339221973,'TI2023F-C01E475','Password@123','BE','Mechanical engineering','NIL','NIL',2020,'mkayalai01@gmail.com','kayalmahe123@gmail.com','Door No: 2/125A, Koothur colony, Koothur post, mannachanallur Tk, Trichy - 621216','Trichy','Mahendhran .N','','Vijayaragini .M');

insert into ai_batch_personal_details values
(14,'Komaladevi. S','2003-07-29',460205744637,05744637,8940898862,7904257743,8940898862,'PU2023F-C01E466
','Password@123','BSC','Computer science','NIL','NIL',2023,'','komaladevi2003@gmail.com','Gandharvakkottai pudukottai
','Pudukottai','M. Subramaniyan','','Kalaiselvi. S');

insert into ai_batch_personal_details values
(15,'LAVANYA M','2001-02-26',629731226643,31226643,7904460924,8248554770,7904460924,'TI2023F-C01EA43
','Password@123','BSC ','Mathematics','NIL','NIL',2021,'','mlavanyam37@gmail.com','33/66 Kamala Nehru Nagar, EB Road
','Trichy','Aravind samy R','','Avadaiyammal');


insert into ai_batch_personal_details values
(16,'Narayanan S','1999-06-14',282903912214,03912214,9361015928,8122648085,9361015928,'TI2023M-C01E78C','Password@123','BA','History','NIL','NIL',2019,'','Naveenkds82@gmail.com','3/141 Sivan kovil street allithurai somarampettai post trichy 620102
','Trichy','Sivaprakasam','','Sumathi');


insert into ai_batch_personal_details values
(17,'Prasanth P','2000-07-27',983315540255,15540255,9361216766,9626922317,9361216766,'PU2023M-C01E445
...
','Pudukkottai','Palanisamy M','','Ponnazhagu P');

insert into ai_batch_personal_details values
(18,'Priya S','2002-5-5',920343048388,43048388,9626940557,9626940557,8508332712,'TI2023F-C01EC0E
...
insert into ai_batch_personal_details values
(20,'Raghul S','2000-06-07',871736862600,36862600,7010107069,987654234,8680827179,'TI2023M-C01E4E6
','Password@123','BE','MECHANICAL ENGINEERING','NIL','NIL',2018,'','rockstarraghul55@gmail.com','3/443 mgr rajaveethi Vs colony Kattur Trichy 620019
','Trichy','Senthil Kumar p','','Sumathi S');
...
insert into ai_batch_personal_details values
(29,'Vinu Andrews S','1999-11-24',543353698598,53698598,8428908488,9876543,8428908488,'TI2023M-C01F2A8','Password@123','Bba','business administration','MBA','Safety',2022,'vinuandrewsai01@gmail.com','vinuandrews10@gmail.com','66, muslim street varaganeri Trichy','Trichy','Selvaraj A
','','Mercy s');

insert into ai_batch_personal_details values
(30,'Yogarajan K','2001-12-15',241602457541,02457541,6379275571,8056724735,6379275571,'TH2023M-C01E455
','Password@123','BCA
...
create table system_info_details
(
SNO int not null primary key auto_increment,
...
internet varchar(50),
foreign key(SNO)references ai_batch_personal_details(sno)
);


insert into system_info_details values
...
select * from system_info_details;

select * from system_info_details;
select * from ai_batch_personal_details;

select ai_batch_personal_details.name,ai_batch_personal_details.user_name,ai_batch_personal_details.password,ai_batch_personal_details.district,
system_info_details.name,system_info_details.OS_Name,system_info_details.PROCESSOR,system_info_details.Mouse_Condition from ai_batch_personal_details
join system_info_details on ai_batch_personal_details.sno=system_info_details.SNO;


select ai_batch_personal_details.name,ai_batch_personal_details.user_name,ai_batch_personal_details.password,ai_batch_personal_details.district,
system_info_details.name,system_info_details.OS_Name,system_info_details.PROCESSOR,system_info_details.Mouse_Condition from ai_batch_personal_details
inner join system_info_details on ai_batch_personal_details.sno=system_info_details.SNO;


select ai_batch_personal_details.name,ai_batch_personal_details.user_name,ai_batch_personal_details.password,ai_batch_personal_details.district,
system_info_details.name,system_info_details.OS_Name,system_info_details.PROCESSOR,system_info_details.Mouse_Condition from ai_batch_personal_details
right join system_info_details on ai_batch_personal_details.sno=system_info_details.SNO;


select ai_batch_personal_details.name,ai_batch_personal_details.user_name,ai_batch_personal_details.password,ai_batch_personal_details.district,
system_info_details.name,system_info_details.OS_Name,system_info_details.PROCESSOR,system_info_details.Mouse_Condition from ai_batch_personal_details
left join system_info_details on ai_batch_personal_details.sno=system_info_details.SNO;


select * from ai_batch_personal_details, system_info_details;
select * from ai_batch_personal_details left join  system_info_details on ai_batch_personal_details.sno =system_info_details.SNO;
select  ai_batch_personal_details.name from ai_batch_personal_details right join  system_info_details on ai_batch_personal_details.sno =system_info_details.SNO;
select district,system_no,ERROR from  ai_batch_personal_details inner join system_info_details on  ai_batch_personal_details.sno = system_info_details.SNO;
